...
public static class CitySeeder
{
    public static async Task SeedAsync(AppDbContext context)
    {
        ...
        var citiesPath = Path.Combine(Directory.GetCurrentDirectory(), "Seeders", "JsonFiles", "cities.json");
        var statesPath = Path.Combine(Directory.GetCurrentDirectory(), "Seeders", "JsonFiles", "states.json");
